package com.charjay.algorithm.struct;
...
public class SortedByValueMapDemo {
	...
	static Map<String, BuzObj> sort(Map<String, BuzObj> buzObjMap){
		List<Entry<String, BuzObj>> entryList = new LinkedList<Entry<String, BuzObj>>(buzObjMap.entrySet());
		Collections.sort(entryList, new Comparator<Entry<String, BuzObj>>() {

			@Override
			public int compare(Entry<String, BuzObj> o1 , Entry<String, BuzObj> o2){
